...
public class fileController {
    ...
    public ResponseEntity<Object> download(@PathVariable long idx)  throws Exception{

        String path = "C:/Users/weaver-gram-0014/Desktop/Project/" + fileservice.findByIdx(idx).getStoredFilePath();
        ...
        try {
            ...
            String fileName = URLEncoder.encode(fileservice.findByIdx(idx).getOriginalFileName(), "UTF-8");
